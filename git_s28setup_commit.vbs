...
ret = shell.Run("cmd /c cd /d """ & scriptDir & """ && git commit -m ""Day 37: feat: S28-setup — web-push installed, VAPID configured, system seed (10 posts), push.ts activated""", 1, True)
