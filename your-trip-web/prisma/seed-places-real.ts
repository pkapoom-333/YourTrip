...
const places = [
  ...
  },
  {
    ...
    descriptionEen: "Boat tour to four stunning islands with emerald water, white sand, a pink beach and coral snorkeling.",
  ...
  },
  {
    ...
    descriptionEen: "Magnificent 105m all-teak sanctuary carved entirely by hand with intricate multi-religious motifs — still under 40-year construction.",
    category: "attraction", region: "east", province: "ชลบุรี", country: "TH",
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    descriptionEen: "Large freshwater lake in the city center with shady park, jogging track, lakeside restaurants and views of Phra That Kham Kaen.",
  ...
  },
  {
    ...
    descriptionEen: "The most important temple of Khon Kaen on an island in the lake, with a stately chedi and tranquil atmosphere.",
    category: "attraction", region: "east", province: "ขอนแก่น", country: "TH",
  ...
  },
  {
    ...
    descriptionEen: "Khon Kaen's hippest café zone with Industrial and Modern style spaces — great for working, relaxing and Instagram-worthy shots.",
