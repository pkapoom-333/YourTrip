...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#398AB9] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-8 w-24 h-24 bg-white/5 rounded-full" />

      {/* Background photo strip */}
      <div
        className="absolute inset-0 bg-cover bg-center opacity-10"
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=60')" }}
      />
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="text-right -mt-1">
              <Link href="/forgot-password" className="text-[#398AB9] text-xs hover:underline">
                Forgot Password?
              </Link>
            </div>
