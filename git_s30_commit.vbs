...
ret = shell.Run("cmd /c cd /d """ & scriptDir & """ && git commit -m ""Day 39: feat: S30-1 trip share as post + S30-2 explore server-side search + S30-3 recently viewed places""", 1, True)
